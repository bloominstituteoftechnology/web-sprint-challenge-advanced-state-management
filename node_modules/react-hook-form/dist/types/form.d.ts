...
import { NonUndefined, LiteralToPrimitive, DeepPartial, DeepMap } from './utils';
...
export declare type UseFormMethods<TFieldValues extends FieldValues = FieldValues> = {
    ...
    setValue<TFieldName extends string, TFieldValue extends TFieldValues[TFieldName]>(name: TFieldName, value: (NonUndefined<TFieldValue> extends NestedValue<infer U> ? U : UnpackNestedValue<DeepPartial<LiteralToPrimitive<TFieldValue>>>) | null | undefined, options?: SetValueConfig): void;
