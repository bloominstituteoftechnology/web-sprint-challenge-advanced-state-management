(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  const getWorkerInstance = (url, options = {}, findWorker) => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const [, mockRegistrations] = yield lib$2.until(() => __awaiter(void 0, void 0, void 0, function* () {
      ...
      const [error, instance] = yield lib$2.until(() => __awaiter(void 0, void 0, void 0, function* () {
...
Learn more about creating the Service Worker script: https://mswjs.io/docs/cli/init`);
  ...
  function deferNetworkRequestsUntil(predicatePromise) {
      ...
      window.XMLHttpRequest.prototype.send = function (...args) {
          ...
          lib$2.until(() => predicatePromise).then(() => {
      ...
      window.fetch = (...args) => __awaiter(this, void 0, void 0, function* () {
          yield lib$2.until(() => predicatePromise);
  ...
  const createStart = (context) => {
      ...
      return function start(options) {
          ...
          const startWorkerInstance = () => __awaiter(this, void 0, void 0, function* () {
              ...
              const [, instance] = yield lib$2.until(() => getWorkerInstance(resolvedOptions.serviceWorker.url, resolvedOptions.serviceWorker.options, resolvedOptions.findWorker));
              if (!instance) {
                  return null;
              }
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`);
              ...
              const [integrityError] = yield lib$2.until(() => requestIntegrityCheck(context, worker));
              if (integrityError) {
                  console.error(`\
...
If this message still persists after updating, please report an issue: https://github.com/open-draft/msw/issues\
      `);
              ...
              const [activationError] = yield lib$2.until(() => activateMocking(context, options));
              if (activationError) {
