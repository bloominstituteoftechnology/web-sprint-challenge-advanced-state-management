...
import { errorAction, addSmurf } from "../actions/index";
...
const AddForm = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (state.name === "" || state.position === "" || state.nickname === "") {
      ...
      props.errorAction("Fill all required fields");
    } else {
      props.addSmurf({
        name: state.name,
...
export default connect(mapStateToProps, { errorAction, addSmurf })(AddForm);
