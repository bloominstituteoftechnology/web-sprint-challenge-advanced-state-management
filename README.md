...
Action from user told to reducer what to do. Reducer is the pure functions that take the current state and action and return the new state. The store is the object which holds the state of the application. 

3. What is the difference between Application state and Component state? When would be a good time to use one over the other?

Component state is local to a single component and cannot be seen outside of this component. Application state is the "global" state that all components in the component tree can access.
...
Redux more complex and interesting for me.
