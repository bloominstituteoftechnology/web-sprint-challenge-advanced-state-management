...
- cuts down prop drilling, easy way for child components to access data stored in parents

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

- the store holds the state for our entire application -- it is immutable. actions are how we update our state (make a copy that our app can use), tells reducers how to update our state when they are dispatched there. reducers are pure functions (take in data, return a single value). reducers do all the work.

3. What is the difference between Application state and Component state? When would be a good time to use one over the other?

- application state is global across the entire application, component state is only accessible in the component it is in.

4. Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

- this allows us to perform asynchronous actions in our applications. It is a middleware that will intercept our action and perform whatever action we tell it (like an API call)

5. What is your favorite state management system you've learned and this sprint? Please explain why!

- context seems much simpler, but I do like Redux, mainly because we've used it more so I am not yet very comfortable it.
