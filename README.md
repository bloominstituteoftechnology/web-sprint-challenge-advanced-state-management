...
<!--Application state is state at any given time for the entire application. Component state is stored locally within a component and isnt accessible from other components. These would be helpful to use depending on if you need state for s single component or your entire application. -->
